  ...
  def specification do
    %{
      specs: %{
        ...
        platform: "Webcore",
        personalisation: "on",
        request_pipeline: ["PersonalisedAccountNonUkRedirect", "ComToUKRedirect", "PersonalisedAccountIsLoggedIn", "PersonalisedAccountU13Redirect", "PersonalisedAccountOffRedirect"]
      }
    }
  end
end
