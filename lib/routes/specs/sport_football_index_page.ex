  ...
  def specification do
    %{
      specs: %{
        ...
        examples: ["/sport/football/womens", "/sport/football/womens.app", "/sport/football/premier-league", "/sport/football/premier-league.app", "/sport/football/fa-cup", "/sport/football/fa-cup.app", "/sport/football/european", "/sport/football/european.app", "/sport/football/european-championship", "/sport/football/european-championship.app", "/sport/football/championship", "/sport/football/championship.app", "/sport/football", "/sport/football.app"]
      }
    }
  end
end
