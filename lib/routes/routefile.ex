...
defmodule Routes.Routefile do
  ...
  ## Sport BBC Live
  handle "/sport/live/football/:id.app", using: "SportFootballLivePage", examples: ["/sport/live/football/52581366.app?morph_env=live&renderer_env=live"]
  handle "/sport/live/football/:id", using: "SportFootballLivePage", examples: ["/sport/live/football/52581366?morph_env=live&renderer_env=live"]
  handle "/sport/live/football/*_any", using: "SportFootballLivePage", examples: ["/sport/live/football/52581366/page/2.app?morph_env=live&renderer_env=live", "/sport/live/football/52581366/page/2?morph_env=live&renderer_env=live"]

  handle "/sport/live/*_any", using: "SportLivePage", examples: ["/sport/live/rugby-union/56269849/page/3.app?morph_env=live&renderer_env=live", "/sport/live/rugby-union/56269849?morph_env=live&renderer_env=live"]
