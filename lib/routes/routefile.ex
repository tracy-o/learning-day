...
defmodule Routes.Routefile do
  ...
  handle "/sport/alpine-skiing", using: "SportTopicPage", examples: ["/sport/alpine-skiing"]
  handle "/sport/archery", using: "SportTopicPage", examples: ["/sport/archery"]
  handle "/sport/badminton", using: "SportTopicPage", examples: ["/sport/badminton"]
  handle "/sport/baseball", using: "SportTopicPage", examples: ["/sport/baseball"]
  handle "/sport/biathlon", using: "SportTopicPage", examples: ["/sport/biathlon"]
  handle "/sport/bobsleigh", using: "SportTopicPage", examples: ["/sport/bobsleigh"]
  handle "/sport/bowls", using: "SportTopicPage", examples: ["/sport/bowls"]
  handle "/sport/canoeing", using: "SportTopicPage", examples: ["/sport/canoeing"]
  handle "/sport/cross-country-skiing", using: "SportTopicPage", examples: ["/sport/cross-country-skiing"]
  handle "/sport/curling", using: "SportTopicPage", examples: ["/sport/curling"]
  handle "/sport/darts", using: "SportTopicPage", examples: ["/sport/darts"]
  handle "/sport/diving", using: "SportTopicPage", examples: ["/sport/diving"]
  handle "/sport/equestrian", using: "SportTopicPage", examples: ["/sport/equestrian"]
  handle "/sport/fencing", using: "SportTopicPage", examples: ["/sport/fencing"]
  handle "/sport/figure-skating", using: "SportTopicPage", examples: ["/sport/figure-skating"]
  handle "/sport/freestyle-skiing", using: "SportTopicPage", examples: ["/sport/freestyle-skiing"]
  handle "/sport/gymnastics", using: "SportTopicPage", examples: ["/sport/gymnastics"]
  handle "/sport/handball", using: "SportTopicPage", examples: ["/sport/handball"]
  handle "/sport/hockey", using: "SportTopicPage", examples: ["/sport/hockey"]
  handle "/sport/ice-hockey", using: "SportTopicPage", examples: ["/sport/ice-hockey"]
  handle "/sport/judo", using: "SportTopicPage", examples: ["/sport/judo"]
  handle "/sport/luge", using: "SportTopicPage", examples: ["/sport/luge"]
  handle "/sport/modern-pentathlon", using: "SportTopicPage", examples: ["/sport/modern-pentathlon"]
  handle "/sport/nordic-combined", using: "SportTopicPage", examples: ["/sport/nordic-combined"]
  handle "/sport/rowing", using: "SportTopicPage", examples: ["/sport/rowing"]
  handle "/sport/rugby-sevens", using: "SportTopicPage", examples: ["/sport/rugby-sevens"]
  handle "/sport/sailing", using: "SportTopicPage", examples: ["/sport/sailing"]
  handle "/sport/shooting", using: "SportTopicPage", examples: ["/sport/shooting"]
  handle "/sport/short-track-skating", using: "SportTopicPage", examples: ["/sport/short-track-skating"]
  handle "/sport/skeleton", using: "SportTopicPage", examples: ["/sport/skeleton"]
  handle "/sport/ski-jumping", using: "SportTopicPage", examples: ["/sport/ski-jumping"]
  handle "/sport/snowboarding", using: "SportTopicPage", examples: ["/sport/snowboarding"]
  handle "/sport/speed-skating", using: "SportTopicPage", examples: ["/sport/speed-skating"]
  handle "/sport/squash", using: "SportTopicPage", examples: ["/sport/squash"]
  handle "/sport/synchronised-swimming", using: "SportTopicPage", examples: ["/sport/synchronised-swimming"]
  handle "/sport/table-tennis", using: "SportTopicPage", examples: ["/sport/table-tennis"]
  handle "/sport/taekwondo", using: "SportTopicPage", examples: ["/sport/taekwondo"]
  handle "/sport/triathlon", using: "SportTopicPage", examples: ["/sport/triathlon"]
  handle "/sport/volleyball", using: "SportTopicPage", examples: ["/sport/volleyball"]
  handle "/sport/water-polo", using: "SportTopicPage", examples: ["/sport/water-polo"]
  handle "/sport/weightlifting", using: "SportTopicPage", examples: ["/sport/weightlifting"]
  handle "/sport/wrestling", using: "SportTopicPage", examples: ["/sport/wrestling"]

  # Sport Topics (Team)
  handle "/sport/:discipline/teams/:team", using: "SportTopicPage", examples: ["/sport/rugby-league/teams/wigan"]

  # Sport Topics (Competition)
  handle "/sport/football/champions-league", using: "SportTopicPage", examples: ["/sport/football/champions-league"]
  handle "/sport/football/dutch-eredivisie", using: "SportTopicPage", examples: ["/sport/football/dutch-eredivisie"]
  handle "/sport/football/europa-league", using: "SportTopicPage", examples: ["/sport/football/europa-league"]
  handle "/sport/football/french-ligue-one", using: "SportTopicPage", examples: ["/sport/football/french-ligue-one"]
  handle "/sport/football/german-bundesliga", using: "SportTopicPage", examples: ["/sport/football/german-bundesliga"]
  handle "/sport/football/italian-serie-a", using: "SportTopicPage", examples: ["/sport/football/italian-serie-a"]
  handle "/sport/football/league-cup", using: "SportTopicPage", examples: ["/sport/football/league-cup"]
  handle "/sport/football/league-one", using: "SportTopicPage", examples: ["/sport/football/league-one"]
  handle "/sport/football/league-two", using: "SportTopicPage", examples: ["/sport/football/league-two"]
  handle "/sport/football/national-league", using: "SportTopicPage", examples: ["/sport/football/national-league"]
  handle "/sport/football/portuguese-primeira-liga", using: "SportTopicPage", examples: ["/sport/football/portuguese-primeira-liga"]
  handle "/sport/football/scottish-challenge-cup", using: "SportTopicPage", examples: ["/sport/football/scottish-challenge-cup"]
  handle "/sport/football/scottish-championship", using: "SportTopicPage", examples: ["/sport/football/scottish-championship"]
  handle "/sport/football/scottish-cup", using: "SportTopicPage", examples: ["/sport/football/scottish-cup"]
  handle "/sport/football/scottish-league-cup", using: "SportTopicPage", examples: ["/sport/football/scottish-league-cup"]
  handle "/sport/football/scottish-league-one", using: "SportTopicPage", examples: ["/sport/football/scottish-league-one"]
  handle "/sport/football/scottish-league-two", using: "SportTopicPage", examples: ["/sport/football/scottish-league-two"]
  handle "/sport/football/scottish-premiership", using: "SportTopicPage", examples: ["/sport/football/scottish-premiership"]
  handle "/sport/football/spanish-la-liga", using: "SportTopicPage", examples: ["/sport/football/spanish-la-liga"]
  handle "/sport/football/us-major-league", using: "SportTopicPage", examples: ["/sport/football/us-major-league"]
  handle "/sport/football/welsh-premier-league", using: "SportTopicPage", examples: ["/sport/football/welsh-premier-league"]
