...
defroutefile "Main" do
  ...
  handle "/cymrufyw/erthyglau/:optimo_id", using: "CymrufywStorytellingPage", platform: "Webcore", examples: ["/cymrufyw/erthyglau/ce56v6pk615o"] do
    return_404 if: !String.match?(optimo_id, ~r/^c[abcdefghjklmnpqrstuvwxyz0-9]{10,}o$/)
  end
  ...
  handle "/naidheachdan/sgeulachdan/:optimo_id", using: "NaidheachdanStorytellingPage", platform: "Webcore", examples: ["/naidheachdan/sgeulachdan/c3gr8907m3po"] do
    return_404 if: !String.match?(optimo_id, ~r/^c[abcdefghjklmnpqrstuvwxyz0-9]{10,}o$/)
  end
  ...
  handle "/container/envelope/error/*any", using: "ContainerEnvelopeError", platform: "Webcore", examples: ["/container/envelope/error/brandPalette/weatherLight/fontPalette/sansSimple/linkText/BBC%20Weather/linkUrl/%2Fweather/status/500?static=true"]
  handle "/container/envelope/navigation-links/*any", using: "ContainerEnvelopeNavigationLinks", platform: "Webcore", examples: ["/container/envelope/navigation-links/brandPalette/weatherLight/corePalette/light/country/gb/fontPalette/sansSimple/hasFetcher/true/language/en/service/weather?static=true"]
  ...
  handle "/newsround/articles/:optimo_id.amp", using: "NewsroundStorytellingAmp", platform: "Simorgh", only_on: "test", examples: [] do
    return_404 if: !String.match?(optimo_id, ~r/^c[abcdefghjklmnpqrstuvwxyz0-9]{10,}o$/)
  end
