...
defroutefile "Main" do
  ...
  handle "/content/cps/naidheachdan/*any", using: "ClassicAppPsNaidheachdan", examples: ["/content/cps/naidheachdan/59371990", "/content/cps/naidheachdan/front_page", "/content/cps/naidheachdan/dachaigh"]
  handle "/content/cps/mundo/*any", using: "ClassicAppWsMundo", examples: ["/content/cps/mundo/vert-cap-59223070?createdBy=mundo&language=es", "/content/cps/mundo/noticias-59340165?createdBy=mundo&language=es"]
  handle "/content/cps/arabic/*any", using: "ClassicAppWsArabic", examples: ["/content/cps/arabic/live?createdBy=arabic&language=ar", "/content/cps/arabic/art-and-culture-59307957?createdBy=arabic&language=ar"]
  handle "/content/cps/russian/*any", using: "ClassicAppWsRussian", examples: ["/content/cps/russian/front_page?createdBy=russian&language=ru", "/content/cps/russian/news?createdBy=russian&language=ru", "/content/cps/russian/features-58536209?createdBy=russian&language=ru"]
  handle "/content/cps/hindi/*any", using: "ClassicAppWsHindi", examples: ["/content/cps/hindi/india?createdBy=hindi&language=hi", "/content/cps/hindi/india-59277161?createdBy=hindi&language=hi"]
