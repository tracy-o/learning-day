...
defroutefile "Main" do
  ...
  handle "/news/england", using: "NewsUk", examples: ["/news/england"]
  ...
  handle "/news/northern_ireland", using: "NewsUk", examples: ["/news/northern_ireland"]
  handle "/news/paradisepapers", using: "News", examples: ["/news/paradisepapers"]
  handle "/news/politics", using: "NewsUk", examples: ["/news/politics"]
  handle "/news/reality_check", using: "News", examples: ["/news/reality_check"]
  handle "/news/science_and_environment", using: "NewsScienceAndTechnology", examples: ["/news/science_and_environment"]
  handle "/news/scotland", using: "NewsUk", examples: ["/news/scotland"]
  handle "/news/stories", using: "News", examples: ["/news/stories"]
  handle "/news/technology", using: "NewsScienceAndTechnology", examples: ["/news/technology"]
