...
defroutefile "Main" do
  ...
  handle "/weather/av/:asset_id", using: "Weather", only_on: "test", examples: ["/weather/av/62556161"]
  ...
  handle "/newsround", using: "NewsroundLegacy", only_on: "live", examples: ["/newsround"]
