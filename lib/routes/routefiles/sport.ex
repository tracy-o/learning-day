...
defroutefile "Sport" do
  ...
  handle "/sport/golf/video/rss.xml", using: "SportTopicRss"
  handle "/sport/olympics/video/rss.xml", using: "SportTopicRss"
  handle "/sport/winter-olympics/video/rss.xml", using: "SportTopicRss"
  handle "/sport/commonwealth-games/video/rss.xml", using: "SportTopicRss"
  handle "/sport/football/world-cup/video/rss.xml", using: "SportTopicRss"
  handle "/sport/football/european-championship/video/rss.xml", using: "SportTopicRss"
  handle "/sport/football/fa-cup/video/rss.xml", using: "SportTopicRss"
  handle "/sport/cricket/the-hundred/video/rss.xml", using: "SportTopicRss"
  ...
  handle "/sport/golf/video", using: "SportWebcoreVideoIndexPage"
  handle "/sport/olympics/video", using: "SportWebcoreVideoIndexPage"
  handle "/sport/winter-olympics/video", using: "SportWebcoreVideoIndexPage"
  handle "/sport/commonwealth-games/video", using: "SportWebcoreVideoIndexPage"
  handle "/sport/football/world-cup/video", using: "SportWebcoreVideoIndexPage"
  handle "/sport/football/european-championship/video", using: "SportWebcoreVideoIndexPage"
  handle "/sport/football/fa-cup/video", using: "SportWebcoreVideoIndexPage"
  handle "/sport/cricket/the-hundred/video", using: "SportWebcoreVideoIndexPage"
