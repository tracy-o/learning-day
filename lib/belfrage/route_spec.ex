defmodule Belfrage.RouteSpec do
  ...
  def merge_key(key, platform_pipeline, routespec_pipeline)
      when (is_list(platform_pipeline) and is_list(routespec_pipeline) and key == :pipeline) or
             key == :response_pipeline do
