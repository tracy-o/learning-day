defmodule Belfrage.PipelineTest do
  ...
  test "process producing a successful response" do
    ...
    assert {:ok, _struct} = Subject.process(original_struct, original_struct.private.pipeline)
  ...
  test "process producing an error response" do
    ...
    assert {:error, _struct, _msg} = Subject.process(original_struct, original_struct.private.pipeline)
  end
end
