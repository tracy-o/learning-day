defmodule Belfrage.Transformers.LocalNewsTopicsRedirectTest do
    ...
    assert {:redirect,
            %Struct{
              response: %Struct.Response{
                http_status: 302,
                headers: %{
                  "location" => "https://www.bbc.com/news/topics/cxrlk4ywplxt",
  ...
  test "If the location ID is not in the mapping, no redirect will be issued" do
    struct =
  ...
  test "If the path does not start with /news/localnews/, no redirect will be issued" do
    struct =
