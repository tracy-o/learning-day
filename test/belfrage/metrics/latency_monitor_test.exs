defmodule Belfrage.Metrics.LatencyMonitorTest do
  ...
  describe "checkpoint/2" do
    ...
    test "sends latency metrics on recording :response_sent checkpoint" do
      ...
      assert sent_metric(metrics) == "web.latency.internal.request:1000|ms|#BBCEnvironment:live"
      assert sent_metric(metrics) == "web.latency.internal.response:2000|ms|#BBCEnvironment:live"
      assert sent_metric(metrics) == "web.latency.internal.combined:3000|ms|#BBCEnvironment:live"
    end
