defmodule EndToEndTest.FormatRewriterTest do
  ...
  describe "when path does not have a trailing format" do
    ...
    test "router handles literal segment" do
      resp_conn = conn(:get, build_https_request_uri("/200-ok-response")) |> Router.call([])
    ...
    test "router handles identifier segment" do
      ...
      resp_conn = conn(:get, build_https_request_uri("/format/rewrite/cricket")) |> Router.call([])
      {matched_route, _matched_fun} = resp_conn.private.plug_route
    ...
    test "router handles identifier segment in the middle of path" do
      ...
      resp_conn = conn(:get, build_https_request_uri("/format/rewrite/cricket/av")) |> Router.call([])
      {matched_route, _matched_fun} = resp_conn.private.plug_route
    ...
    test "router handles multiple identifier segments" do
      ...
      resp_conn = conn(:get, build_https_request_uri("/format/rewrite/cricket/av/india")) |> Router.call([])
      {matched_route, _matched_fun} = resp_conn.private.plug_route
  ...
  describe "when path has a trailing format" do
    ...
    test "router handles identifier segment" do
      ...
      resp_conn = conn(:get, build_https_request_uri("/format/rewrite/cricket.app")) |> Router.call([])
      {matched_route, _matched_fun} = resp_conn.private.plug_route
    ...
    test "router handles multiple identifier segments" do
      ...
      resp_conn = conn(:get, build_https_request_uri("/format/rewrite/cricket/av/india.app")) |> Router.call([])
      {matched_route, _matched_fun} = resp_conn.private.plug_route
  ...
  describe "when path has multiple formats" do
    ...
    test "router handles identifier segment" do
      # /format/rewrite/:discipline.app route
      resp_conn = conn(:get, build_https_request_uri("/format/rewrite/athletics.200m.app")) |> Router.call([])
      {matched_route, _matched_fun} = resp_conn.private.plug_route
    ...
    test "router handles multiple identifier segments" do
      # /format/rewrite/:discipline/av/:team.app route
      resp_conn = conn(:get, build_https_request_uri("/format/rewrite/athletics.200m/av/india.delhi.app")) |> Router.call([])
      {matched_route, _matched_fun} = resp_conn.private.plug_route
