defmodule VaryCacheByHost do
  ...
  setup do
    ...
    %{
      ...
      edge_host: conn(:get, "/200-ok-response") |> put_req_header("x-bbc-edge-host", "host.com"),
      forwarded_host: conn(:get, "/200-ok-response") |> put_req_header("x-forwarded-host", "forwarded.com")
    }
  end
