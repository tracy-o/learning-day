...
Mox.defmock(Belfrage.Dial.ClientMock, for: Belfrage.Dial.Client, skip_optional_callbacks: true)
Mox.defmock(Belfrage.Dial.ClientWithOptionalCallbackMock, for: Belfrage.Dial.Client)
Mox.defmock(Belfrage.DialMock, for: Belfrage.Dial)
