...
defroutefile "RoutefileOnlyOnMock", "test" do
  handle("/only-on", using: "SomeRouteState", only_on: "test", examples: ["/only-on"])

  handle("/only-on-with-block", using: "SomeRouteState", only_on: "test", examples: ["/only-on-with-block"]) do
