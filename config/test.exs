...
config :belfrage,
  ...
  three_endpoint: "https://bbcthree-web-server.test.api.bbc.co.uk",
  ...
  dotcom_newsletters_endpoint: "https://ugas-cdn.gnl-test.bbcverticals.com",
