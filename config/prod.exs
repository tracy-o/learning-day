...
config :ingress, http_cert: System.get_env("DEV_CERT_PEM")
config :ingress, http_cert_key: System.get_env("DEV_CERT_PEM")
config :ingress, http_cert_ca: System.get_env("DEV_CA_PEM")
